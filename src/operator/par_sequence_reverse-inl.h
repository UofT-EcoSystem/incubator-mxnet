...
struct ParSequenceReverseParam : public dmlc::Parameter < ParSequenceReverseParam >
{
	unsigned seq_length, batch_size, state_size;

	bool use_sequence_length;

	DMLC_DECLARE_PARAMETER(ParSequenceReverseParam)
	{
...
class ParSequenceReverseOp : public Operator
{
private:
	ParSequenceReverseParam _param;
public:
	explicit ParSequenceReverseOp(ParSequenceReverseParam param)
	{
		// empty
	}
...
Operator * CreateOp(ParSequenceReverseParam param, int dtype);

#if DMLC_USE_CXX11

class ParSequenceReverseProp : public OperatorProperty
{
private:
	ParSequenceReverseParam _param;
public:
	ParSequenceReverseProp() {}
	explicit ParSequenceReverseProp(ParSequenceReverseParam param) : _param(param) {}
	...
	{
		return new ParSequenceReverseProp(_param);
	}

	std::string TypeString() const override
	{
		return "ParSequenceReverse";
	}
